...
%         [h, g] = butter(2, [1.5/(0.5 * samplerate) 9.5/(0.5 * samplerate)], 'bandpass');
%         tremor1 = filtfilt(h, g, data_temp.x) * 10 * 9.81 / 0.5;
%         [Pxx, F] = pwelch(tremor1, samplerate, [], samplerate, samplerate);
%         figure
%         plot(F, Pxx);
%         data_temp.x = tremor1;
